...
#define MCAN_ERROR_BASE        (DRIVER_ERROR_BASE | 0x1500)
...
#define MEM_TYPE_IO_ECSPI_SLAVE_INFO_STRUCT  1063
...
#define MEM_TYPE_IO_ASRC_END                 1l71
...
extern void             _mem_copy(void *, void *, _mem_size);
#else
# include <string.h>
...
extern int32_t               _time_diff_nanoseconds(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, bool *);
extern int32_t               _time_diff_picoseconds(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, bool *);
extern int32_t               _time_diff_seconds(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, bool *);
extern int32_t               _time_diff_microseconds(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, bool *);
extern _mqx_uint            _time_diff_ticks(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, MQX_TICK_STRUCT_PTR);
extern int32_t               _time_diff_ticks_int32(MQX_TICK_STRUCT_PTR,
   MQX_TICK_STRUCT_PTR, bool *);
